import type { SupportMessage, SupportReaction } from '../../protocol';
import { slackReactionToUnicode } from '../../emoji';
import { jsonReactions, parseReactions } from '../../core/utils';
import type { FeatureHost, MessageRow } from '../../core';
