...
import type { FeatureHost } from '@cf-slack-support/core';
import type { SupportConversation } from '@cf-slack-support/protocol';
import { lifecycleFeature } from '../src/index';
